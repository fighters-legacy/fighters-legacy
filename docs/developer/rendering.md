...
> [`CLAUDE.md`](https://github.com/fighters-legacy/fighters-legacy/blob/main/CLAUDE.md); for the high-level layering, see
> [`docs/developer/architecture.md`](architecture.md); for upstream technique citations, see
> [`docs/developer/references.md`](references.md).
...
Brief per-technique notes; citations in [`docs/developer/references.md`](references.md).

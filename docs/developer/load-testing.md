...
fixed 64 B; see [snapshot-quantization.md](decisions/snapshot-quantization.md)), and each client's snapshot is
...
[entity-scale-characterization.md](decisions/entity-scale-characterization.md)). It asserts the governor
*responded*:
...
run matrix live in [entity-scale-characterization.md](decisions/entity-scale-characterization.md).
...
[entity-scale-characterization.md](decisions/entity-scale-characterization.md).
...
[docs/developer/decisions/congestion-control-design.md](decisions/congestion-control-design.md).
...
[entity-scale-characterization.md](decisions/entity-scale-characterization.md); the [#572] / [#575] trigger
...
The gate layer is [`.github/workflows/scale-gate.yml`](https://github.com/fighters-legacy/fighters-legacy/blob/main/.github/workflows/scale-gate.yml), driven
by [`tools/bot_swarm/scale_gate.py`](https://github.com/fighters-legacy/fighters-legacy/blob/main/tools/bot_swarm/scale_gate.py) reading thresholds from
[`scale-gate.json`](https://github.com/fighters-legacy/fighters-legacy/blob/main/tools/bot_swarm/scale-gate.json). The driver runs `run_loadtest.sh`/`.ps1`
...
[reference-env](https://github.com/fighters-legacy/fighters-legacy/blob/main/tools/bot_swarm/reference-env/README.md), so it is enforced there: the
[strict tier](https://github.com/fighters-legacy/fighters-legacy/blob/main/tools/bot_swarm/reference-env/README.md#self-hosted-reference-runner-ci-strict-tier)
...
**Baseline.** [`scale-gate-baseline.json`](https://github.com/fighters-legacy/fighters-legacy/blob/main/tools/bot_swarm/scale-gate-baseline.json) holds the

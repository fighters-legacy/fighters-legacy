...
[`docs/developer/references.md`](references.md) (issue #80). This document is motivation and landscape;
...
[`docs/developer/design.md`](design.md) for the fidelity target that drives it.

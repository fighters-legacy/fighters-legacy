...
- `docs/developer/development.md` — Dependencies table + `platform/net/` description + prerequisites gain
  protobuf/libsodium → **[#509]**.
- `docs/server-ops/server-config.md` — a `[network] transport =` selector knob + "ENet"→"transport"
  phrasing → **[#507]/[#508]**.
- `docs/developer/load-testing.md` — re-validate the transport ceiling post-swap with `bot_swarm` →
  **[#507]** validation.
...
- Reference-env ceiling data — [#505]; application-level congestion response —
  [docs/developer/decisions/congestion-control-design.md](congestion-control-design.md) ([#518]).
